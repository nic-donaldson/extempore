...
// NOMERGE: removed 'inline' modifiers here
...
{
    // NOMERGE: changed to use static_cast here
    return *(static_cast<uint64_t*>(ptr) - 1);
}
...
//NOMERGE: dropped `inline` here
static llvm_zone_t* llvm_threads_get_callback_zone()
{
